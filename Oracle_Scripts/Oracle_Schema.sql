...
(
  Customer_ID       int GENERATED ALWAYS 
      AS IDENTITY 
      (START WITH 1 
       INCREMENT BY 1 
       MINVALUE 1 
...
(
  Id_transfer                   int GENERATED ALWAYS 
      AS IDENTITY 
      (START WITH 1 
       INCREMENT BY 1 
       MINVALUE 1 
  ...
  transport_type                int,
  CONSTRAINT pk_TRANSPORT Primary Key (Id_transfer),
...
(
  ...
  CONSTRAINT pk_SHIPMENT_TYPE Primary Key (ID)
);
...
(
  shipment_number int GENERATED ALWAYS 
      AS IDENTITY 
      (START WITH 1 
       INCREMENT BY 1 
       MINVALUE 1 
  ...
  CONSTRAINT pk_SHIPMENT Primary Key (shipment_number)
);
...
(
  ...
  CONSTRAINT pk_PRODUCT_SHIPMENT Primary Key (ID)
);
...
(
  ...
  CONSTRAINT pk_PACKAGING_SHIPPING Primary Key (shipping_ID)
);
...
(
  ...
  CONSTRAINT pk_CONTRACT Primary Key (Account_num)
);
...
INSERT INTO SHIPMENT_TYPE(shipment_Type,shipment_location,shipment_time) VALUES ('Pick Up','cairo',TO_DATE('21:30', 'hh24:mi'));
INSERT INTO SHIPMENT_TYPE(shipment_Type,shipment_location,shipment_time) VALUES ('Pick Up','Alex',TO_DATE('12:30', 'hh24:mi'));
INSERT INTO SHIPMENT_TYPE(shipment_Type,shipment_location,shipment_time) VALUES ('Pick Up','Assuit',TO_DATE('10:30', 'hh24:mi'));
INSERT INTO SHIPMENT_TYPE(shipment_Type,shipment_location,shipment_time,Delegate_Name,Delegate_Number) VALUES ('Delivery','Sohag',TO_DATE('21:30', 'hh24:mi'),'mahmoud Mostafa','01545454654');
INSERT INTO SHIPMENT_TYPE(shipment_Type,shipment_location,shipment_time,Delegate_Name,Delegate_Number) VALUES ('Delivery','Cairo',TO_DATE('21:30', 'hh24:mi'),'Mohamed Ahmed','01065464056');

/** INSERT Data In Shipment Table **/
INSERT INTO SHIPMENT(Customer_ID,Company_name,shipment_date,delivery_date,shipment_weight,shipment_type) VALUES (1,'Logistics Compnay',TO_DATE('2022/12/12', 'yyyy/mm/dd'),TO_DATE('2022/12/15', 'yyyy/mm/dd'),'20.5',1);
INSERT INTO SHIPMENT(Customer_ID,Company_name,shipment_date,delivery_date,shipment_weight,shipment_type) VALUES (2,'Logistics Compnay',TO_DATE('2022/12/12', 'yyyy/mm/dd'),TO_DATE('2022/12/15', 'yyyy/mm/dd'),'40.5',2);
INSERT INTO SHIPMENT(Customer_ID,Company_name,shipment_date,delivery_date,shipment_weight,shipment_type) VALUES (2,'Logistics Compnay',TO_DATE('2022/12/12', 'yyyy/mm/dd'),TO_DATE('2022/12/15', 'yyyy/mm/dd'),'80.5',4);
INSERT INTO SHIPMENT(Customer_ID,Company_name,shipment_date,delivery_date,shipment_weight,shipment_type) VALUES (3,'Logistics Compnay',TO_DATE('2022/12/12', 'yyyy/mm/dd'),TO_DATE('2022/12/15', 'yyyy/mm/dd'),'25.5',5);
INSERT INTO SHIPMENT(Customer_ID,Company_name,shipment_date,delivery_date,shipment_weight,shipment_type) VALUES (5,'Logistics Compnay',TO_DATE('2022/12/12', 'yyyy/mm/dd'),TO_DATE('2022/12/15', 'yyyy/mm/dd'),'50',3);
...
INSERT INTO PACKAGING_SHIPPING(shipping_ID,shipping_date) VALUES (1,TO_DATE('2022/12/12', 'yyyy/mm/dd'));
INSERT INTO PACKAGING_SHIPPING(shipping_ID,shipping_date) VALUES (2,TO_DATE('2022/12/12', 'yyyy/mm/dd'));
INSERT INTO PACKAGING_SHIPPING(shipping_ID,shipping_date) VALUES (3,TO_DATE('2022/12/12', 'yyyy/mm/dd'));
INSERT INTO PACKAGING_SHIPPING(shipping_ID,shipping_date) VALUES (4,TO_DATE('2022/12/17', 'yyyy/mm/dd'));
INSERT INTO PACKAGING_SHIPPING(shipping_ID,shipping_date) VALUES (5,TO_DATE('2022/12/17', 'yyyy/mm/dd'));
...
VALUES (1,TO_DATE('21:00', 'hh24:mi'),TO_DATE('2023/1/1', 'yyyy/mm/dd'),50,'0105054948','Ahmed Ali',1);
INSERT INTO CONTRACT(Account_num,shipping_time,Date_Expiry_Contract,cost,Sender_Phone_Number,Sender_Name,Contract_type) 
VALUES (2,TO_DATE('12:00', 'hh24:mi'),TO_DATE('2023/1/1', 'yyyy/mm/dd'),50,'0105054948','salma Ahmed',4);
INSERT INTO CONTRACT(Account_num,shipping_time,Date_Expiry_Contract,cost,Sender_Phone_Number,Sender_Name,Contract_type) 
VALUES (3,TO_DATE('1:00', 'hh24:mi'),TO_DATE('2023/1/1', 'yyyy/mm/dd'),50,'0105054948','Osama Ahmed',2);
INSERT INTO CONTRACT(Account_num,shipping_time,Date_Expiry_Contract,cost,Sender_Phone_Number,Sender_Name,Contract_type) 
VALUES (4,TO_DATE('2:00', 'hh24:mi'),TO_DATE('2023/1/1', 'yyyy/mm/dd'),50,'0105054948','Ali Mohamed',5);
INSERT INTO CONTRACT(Account_num,shipping_time,Date_Expiry_Contract,cost,Sender_Phone_Number,Sender_Name,Contract_type) 
VALUES (5,TO_DATE('3:00', 'hh24:mi'),TO_DATE('2023/1/1', 'yyyy/mm/dd'),50,'0105054948','Mostafa Ahmed',3);
